...
test_that("quarto_website gets index.qmd including README.qmd when present", {
    dir <- local_readme_package(
        "README.md" = "# readme",
...
test_that("quarto_website gets index.qmd including README.md when README.qmd is absent", {
    dir <- local_readme_package(
        "README.md" = "# readme"
    )
    withr::local_dir(dir)

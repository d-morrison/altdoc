...
---
    ...
    Output
      ...
      [47] "\t\t\t\t],"                                                                                                                                                                                                                                
      [48] "        footer: \"<a href='$ALTDOC_PACKAGE_URL'> ` $ALTDOC_PACKAGE_NAME ` v. $ALTDOC_PACKAGE_VERSION </a> | Documentation made with <a href='https://altdoc.etiennebacher.com/'> ` altdoc ` v. $ALTDOC_VERSION</a>\""
      [49] "      })"                                                                                                                                                                                                                                  
      [50] "    </script>"                                                                                                                                                                                                                             
      [51] "  </body>"                                                                                                                                                                                                                                 
      [52] "</html>"                                                                                                                                                                                                                                   
...
---
    ...
    Output
      ...
      [17] "<tr>"                                                                             
      [18] "<td style=\"white-space: collapse; font-family: monospace; vertical-align: top\">"
      [19] "<code id=\"x\">x</code>"                                                          
      [20] "</td>"                                                                            
      [21] "<td>"                                                                             
      [22] "A parameter"                                                                      
...
---
    ...
    Output
       ...
       [15] "<li>"                                                                 
       [16] ""                                                                     
       [17] "<a href=\"#method-Conductor-new\">`hello_r6$new()`</a>"
       [18] ""                                                                     
       [19] "</li>"                                                                
       [20] "<li>"                                                                 
       [21] ""                                                                     
       [22] "<a href=\"#method-Conductor-init\">`hello_r6$init()`</a>"
       [23] ""                                                                     
       [24] "</li>"                                                                
       [25] "<li>"                                                                 
       [26] ""                                                                     
       [27] "<a href=\"#method-Conductor-step\">`hello_r6$step()`</a>"
       [28] ""                                                                     
       [29] "</li>"                                                                
       [30] "<li>"                                                                 
       [31] ""                                                                     
       [32] "<a href=\"#method-Conductor-clone\">`hello_r6$clone()`</a>"
       [33] ""                                                                     
       [34] "</li>"                                                                
       [35] "</ul>"                                                                
       [36] "<hr>"                                                                 
       ...
       [75] "</dt>"                                                                
       [76] "<dd>"                                                                 
       [77] "A valid Shiny session. If `NULL` (default), the function"

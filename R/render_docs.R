...
#' * `docs/README.md`
#'   - README.md
#'   - Note: `README.md` is required, and is always copied. For `quarto_website`, if `README.qmd` is present, it is copied and included directly in `index.qmd`. For other generators, `README.qmd` and `README.Rmd` are not rendered for you, so keep `README.md` in step with whichever of them you write in.
#' * `docs/NEWS.md`
#'   - NEWS

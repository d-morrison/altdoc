...
#' * `docs/README.md`
#'   - README.md
#'   - Note: `README.md` is required. For Quarto websites (`quarto_website`), if `README.qmd` is present, it is copied and included directly in `index.qmd`. For other generators, `README.md` is copied. Keep `README.md` in step with `README.qmd` or `README.Rmd` if writing in those formats.
#' * `docs/NEWS.md`
#'   - NEWS

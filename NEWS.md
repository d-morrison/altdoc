...
* Added: `$ALTDOC_PACKAGE_AUTHORS`, `$ALTDOC_PACKAGE_AUTHOR`, and `$ALTDOC_PACKAGE_CONTRIBUTORS` variables,
  extracting authors (roles "aut" and "cre", or fallback to the `Author` field) and contributors (role "ctb")

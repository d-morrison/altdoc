...
If you want versioned documentation (for example one site per release tag and a
landing page with a versions switcher), generate the workflow with:
...
In multiversion mode, docs are deployed under `gh-pages/<branch-or-tag>/`, and
an additional job runs

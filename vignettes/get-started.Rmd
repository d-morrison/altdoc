...
* `$ALTDOC_PACKAGE_AUTHORS`: Package authors extracted from `DESCRIPTION` (roles `aut` or `cre`, or fallback to `Author` field).
* `$ALTDOC_PACKAGE_AUTHOR`: Alias for `$ALTDOC_PACKAGE_AUTHORS`.
* `$ALTDOC_PACKAGE_CONTRIBUTORS`: Package contributors with `ctb` role extracted from `DESCRIPTION`.

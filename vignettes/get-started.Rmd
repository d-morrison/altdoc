...
* `$ALTDOC_PACKAGE_AUTHORS` or `$ALTDOC_PACKAGE_AUTHOR`: Authors of the package extracted from `DESCRIPTION`.
* `$ALTDOC_PACKAGE_CONTRIBUTORS`: Contributors to the package extracted from `DESCRIPTION`.

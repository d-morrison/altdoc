...
#' * `$ALTDOC_PACKAGE_AUTHORS` (or `$ALTDOC_PACKAGE_AUTHOR`): Author(s) of the package from `DESCRIPTION`.
#' * `$ALTDOC_PACKAGE_CONTRIBUTORS`: Contributor(s) of the package from `DESCRIPTION`.
